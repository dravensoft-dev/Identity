...
| 4 | `2026-07-18-4-token-geometry-boundary.md` | **This plan** — pending |
...
- [ ] **Step 1: Add the gate to the aggregate**
...
Expected: **eight steps, all passing.** If `check-dimension-literals` fails here, the layer is not actually repaired and no amount of documentation fixes that.
...
Expected: eight steps pass, the suite passes, `check-release` passes, and no version string moved.
