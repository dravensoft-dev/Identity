...
> `specs/2026-07-18-4-token-geometry-boundary-design.md`). Under that rule, adding
...
**Source spec:** `docs/superpowers/specs/2026-07-18-3-framework-layer-token-coverage-design.md`
**Downstream, do not implement here:** `docs/superpowers/specs/2026-07-18-5-framework-layer-parity-design.md`, `docs/superpowers/specs/2026-07-18-6-four-package-build-publish-design.md`
...
- **Grow Angular past one primitive or Tailwind past two manifests.** That is `2026-07-18-5-framework-layer-parity-design.md`, and it starts from `Tag.manifest.json` as its slice 1.
...
- **Publish anything.** `2026-07-18-6-four-package-build-publish-design.md` (plan 6) waits on parity (plan 5), which waits on the token/geometry boundary (plan 4, `specs/2026-07-18-4-token-geometry-boundary-design.md`), which waits on this.
...
- **A separate spec is owed: React consuming `tokens/src/` directly.** The audit in the
  ...
  **That spec is now written: `specs/2026-07-18-4-token-geometry-boundary-design.md`,
