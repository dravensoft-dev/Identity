...
`layers.mjs` and `repo-root.mjs`, because it belongs to no layer in particular.
...
| domain | modules | |
| --- | --- | --- |
| [`arena/`](./arena/README.md) | 10 | belongs to no one layer: parsers, the browser harness, the tree's own facts |
