...
export const PILOT = ['Card'];

export const PAGE_BANNER =
  '<!-- GENERATED by scripts/generate/arena/generate-playgrounds.mjs. '
  + 'Edit the contract or the fixture, not this file. -->\n';

export const ENTRY_BANNER =
  '/* GENERATED by scripts/generate/arena/generate-playgrounds.mjs from the component\'s API\n'
...
export function componentFiles(base = root, components = PILOT) {
...
export function buildPlaygrounds(base = root, components = PILOT) {
