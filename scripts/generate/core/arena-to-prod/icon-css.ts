...
export function scan(source: string, found = { pairs: new Map(), loose: new Set() }) {
...
export function sheetRules(css: string, weight) {
...
export function woff2Source(css: string, weight) {
...
export function subset(css: string, weight, glyphs, fontPath) {
...
export function iconsCss(sheets, source: string) {
