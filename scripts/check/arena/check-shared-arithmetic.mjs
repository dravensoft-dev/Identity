...
export const PAIRED = [
  ...
  'WarnOnce.ts',
  'DataVisuals.ts',
  'components/display/calendar/CalendarInternals.ts',
  'components/navigation/pagination/PaginationWindow.ts',
];
...
export const DIVERGENT = new Map([
  ...
  ['components/display/calendar/CalendarInternals.ts:addDays',
  ...
  ['components/display/calendar/CalendarInternals.ts:placeEvents',
  ...
  ['components/display/calendar/CalendarInternals.ts:layoutDay',
  ...
  ['components/display/calendar/CalendarInternals.ts:zonedParts',
   'the same parse; one accepts null in addition to undefined, because its caller can hold one.'],
  ['components/display/calendar/CalendarInternals.ts:rangeTitle',
   'the same title over the same formatter; one takes a readonly array.'],
  ['components/display/calendar/CalendarInternals.ts:parseHM',
   'the same parse, over a local pad helper the two layers name differently.'],
  ['components/navigation/pagination/PaginationWindow.ts:pageWindow',
