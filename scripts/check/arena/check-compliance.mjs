...
export const COVERED = {
  ...
  'ToastHost:react': 'InertComponents.dom.test.tsx',
  'Sheet:react': 'Sheet.disclosure.dom.test.tsx',
  'Grid:react': 'InertComponents.dom.test.tsx',
  'BottomNav:react': 'BottomNav.cases.dom.test.tsx',
  'BottomNavItem:react': 'BottomNav.cases.dom.test.tsx',
  ...
  'ToastHost:angular': 'ToastHost.compliance.test.ts',
  'Sheet:angular': 'Sheet.compliance.test.ts',
  'Grid:angular': 'Grid.compliance.test.ts',
  'BottomNav:angular': 'BottomNav.compliance.test.ts',
  'BottomNavItem:angular': 'BottomNavItem.cases.test.ts',
