...
| `check-manifest-states.mjs` | a manifest declares a `hover:`/`focus:` state modifier whose mirrored React component implements no hover or focus anywhere. This checks **states only** — nothing about colors, sizes or slot structure. |
