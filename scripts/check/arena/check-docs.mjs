...
export function documentSizeProblems(root = ROOT) {
  const documents = walk(root, (p) => p.endsWith('.md'), emittedTree(root));
  const problems = [];
