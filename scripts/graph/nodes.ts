...
export const NOT_YET_SUBSCRIBED = new Set([
  ...
  'scripts/check/angular/check-angular-demos.ts',
  'scripts/check/angular/check-angular.ts',
  'scripts/check/angular/check-assertions.ts',
  'scripts/check/angular/check-cdk.ts',
  'scripts/check/arena/check-api.ts',
  'scripts/check/arena/check-appearance.ts',
  'scripts/check/arena/check-behaviour.ts',
  'scripts/check/arena/check-card-viewports.ts',
  'scripts/check/arena/check-compliance.ts',
  'scripts/check/arena/check-consumer.ts',
  'scripts/check/arena/check-contracts.ts',
  'scripts/check/arena/check-dimension-literals.ts',
  'scripts/check/arena/check-duplicate-constants.ts',
  'scripts/check/arena/check-focus-trap.ts',
  'scripts/check/arena/check-generated.ts',
  'scripts/check/arena/check-icons.ts',
  'scripts/check/arena/check-intro-generated.ts',
  'scripts/check/arena/check-layer-independence.ts',
  'scripts/check/arena/check-manifest-states.ts',
  'scripts/check/arena/check-packages.ts',
  'scripts/check/arena/check-playgrounds.ts',
  'scripts/check/arena/check-prompts.ts',
  ...
  'scripts/check/react/check-vendor-generated.ts',
