/* GENERATED by scripts/build/tailwind/build-tailwind.mjs — edit ConfirmDialog.manifest.json, not this file. */
export default {
  "component": "ConfirmDialog",
  "slots": {
    "root": "fixed inset-0 z-modal-nested flex items-center justify-center bg-scrim backdrop-blur-scrim",
    ...
    "cancel": "inline-flex items-center justify-center h-ctl-h px-4.5 rounded-sm border-[length:var(--bw)] border-transparent bg-transparent text-base-content/82 font-body font-semibold text-ctl cursor-pointer gap-2 transition-[background,box-shadow] duration-[var(--dur-fast)] ease-[var(--ease-out)]",
    "confirm": "inline-flex items-center justify-center h-ctl-h px-4.5 rounded-sm border-[length:var(--bw)] border-transparent font-body font-semibold text-ctl cursor-pointer disabled:opacity-45 disabled:cursor-not-allowed gap-2 transition-[background,box-shadow] duration-[var(--dur-fast)] ease-[var(--ease-out)] hover:shadow-2"
  },
  "variants": {
    "destructive": {
      "true": {
        "eyebrow": "text-error",
        "confirm": "bg-error-fill text-error-content"
      },
      "false": {
        "eyebrow": "text-primary",
        "confirm": "bg-primary text-primary-content"
      }
    },
    "invalid": {
      "true": {
