/* GENERATED by scripts/build/tailwind/build-tailwind.mjs — edit ErrorState.manifest.json, not this file. */
export default {
  ...
  "slots": {
    ...
    "retry": "inline-flex items-center justify-center h-ctl-h px-4.5 rounded-sm border-[length:var(--bw)] font-body font-semibold text-ctl cursor-pointer gap-2 transition-[background,box-shadow] duration-[var(--dur-fast)] ease-[var(--ease-out)] bg-primary text-primary-content border-primary hover:shadow-2"
  }
} as const;
