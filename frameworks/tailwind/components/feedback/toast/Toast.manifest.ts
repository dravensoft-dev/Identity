/* GENERATED by scripts/build/tailwind/build-tailwind.mjs — edit Toast.manifest.json, not this file. */
export default {
  "component": "Toast",
  "slots": {
    "root": "flex gap-3 items-start w-85 px-4 py-3.5 z-toast bg-base-200 border-t-[length:var(--bw)] border-r-[length:var(--bw)] border-b-[length:var(--bw)] border-t-base-300 border-r-base-300 border-b-base-300 border-l-[length:var(--bw-strong)] rounded-md shadow-2",
    "body": "flex-1",
