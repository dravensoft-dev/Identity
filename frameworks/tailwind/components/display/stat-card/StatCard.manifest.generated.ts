/* GENERATED by scripts/build/tailwind/build-tailwind.mjs — edit StatCard.manifest.json, not this file. */
export default {
  "component": "StatCard",
  "slots": {
  ...
  "variants": {
    ...
    "deltaTone": {
      ...
      "positive": {
        "delta": "border-success text-success"
      },
      "negative": {
        "delta": "border-error text-error"
      }
    }
  },
  "defaultVariants": {
