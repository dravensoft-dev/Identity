/* GENERATED by scripts/build-tailwind.mjs — edit Menu.manifest.json, not this file. */
export default {
  "component": "Menu",
  "slots": {
    ...
    "item": "flex items-center gap-2.5 w-full text-left px-2.5 py-2 border-none rounded-sm bg-transparent font-body text-md text-base-content/82",
    "itemDefault": "cursor-pointer hover:bg-primary/14 hover:text-primary",
    "itemDestructive": "cursor-pointer text-error hover:bg-error/14 hover:text-error",
