/* GENERATED by scripts/build/tailwind/build-tailwind.mjs — edit Menu.manifest.json, not this file. */
export default {
  "component": "Menu",
  "slots": {
    "root": "inline-flex",
    ...
    "itemDisabled": "text-base-content/62 opacity-60 cursor-not-allowed",
