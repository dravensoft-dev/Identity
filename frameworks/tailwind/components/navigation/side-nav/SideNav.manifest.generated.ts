/* GENERATED by scripts/build/tailwind/build-tailwind.mjs — edit SideNav.manifest.json, not this file. */
export default {
  "component": "SideNav",
  "slots": {
  ...
  "variants": {
    "active": {
      "true": {
        "item": "bg-primary/14 text-primary font-semibold"
      },
      "false": {
        "item": "bg-transparent text-base-content/62 font-medium"
      }
    }
  },
  "defaultVariants": {
