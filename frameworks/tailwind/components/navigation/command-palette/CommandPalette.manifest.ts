/* GENERATED by scripts/build/tailwind/build-tailwind.mjs — edit CommandPalette.manifest.json, not this file. */
export default {
  "component": "CommandPalette",
  "slots": {
    "root": "fixed inset-0 z-palette flex items-start justify-center pt-[12vh] bg-scrim backdrop-blur-scrim",
    ...
    "row": "flex items-center gap-3 w-full text-left px-3 py-2.5 rounded-sm border-none cursor-pointer",
    "rowDefault": "bg-transparent text-base-content/82",
    "rowActive": "bg-primary/14 text-primary",
    "rowIcon": "inline-flex text-[length:var(--icon-lg)]",
    "rowLabel": "flex-1 font-body text-ctl",
    "rowLabelDefault": "font-medium",
