/* GENERATED by scripts/build/tailwind/build-tailwind.mjs — edit SegmentedControl.manifest.json, not this file. */
export default {
  ...
  "variants": {
    "size": {
      "sm": {
        "segment": "h-7 px-2.5 text-ctl-sm"
      },
      "md": {
        "segment": "h-8.5 px-3.5 text-ctl-md"
      }
    },
    "selected": {
      "true": {
        "segment": "bg-neutral text-base-content font-semibold shadow-1"
      },
      "false": {
        "segment": "bg-transparent text-base-content/62 font-medium hover:text-base-content/82"
      }
    }
  },
  "defaultVariants": {
