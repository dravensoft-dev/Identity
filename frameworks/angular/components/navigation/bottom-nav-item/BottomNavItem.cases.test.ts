/* The per-case suite this item's binding requires, the same shape as SideNavItem's: with an
...
const BINDING = join(ANGULAR_COMPONENTS, 'navigation/bottom-nav-item/BottomNavItem.behaviour.json');
