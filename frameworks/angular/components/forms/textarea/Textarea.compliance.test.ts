...
const BINDING = join(ANGULAR_COMPONENTS, 'forms/textarea/Textarea.behaviour.json');
...
test('the label points at the control by a ta- slug, which is not Input\'s prefix', () => {
