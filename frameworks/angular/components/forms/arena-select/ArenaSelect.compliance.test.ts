 ...
 * is the whole reason ArenaSelect binds `select` rather than `combobox`. What is NOT free is
...
const BINDING = join(ANGULAR_COMPONENTS, 'forms/arena-select/ArenaSelect.behaviour.json');
