...
import { ARENA_CHART_HEIGHT, arenaArcPath } from '../../../DataVisuals';
import {
  arenaDoughnutSlices, arenaDoughnutLegendWidth, arenaDoughnutPlotWidth, arenaDoughnutRadii,
} from './ArenaDoughnutChart';
