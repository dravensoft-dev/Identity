...
its label. The host owns `open` and the shortcut that sets it, and decides whether
running a command also closes the palette. The search field is an ARIA 1.2 combobox
