...
import manifest from '../../../tailwind/components/ThemeToggle.manifest';

/** Recipe for `arena-theme-toggle`. Both `ThemeToggle.manifest.ts` (the
 *  literal-typed build output) and `ThemeToggle.manifest.json` (its source)
