...
1. **Login**: access screen with branding (`ArenaAppLogo`, the Rotor mark plus wordmark) on the warm base surface.
...
ArenaButton, ArenaIconButton, ArenaInput, ArenaSwitch, ArenaCard, ArenaBadge, ArenaTag, ArenaTabs, ArenaDialog, ArenaToast, ArenaAppLogo.
