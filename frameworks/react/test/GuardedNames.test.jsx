...
import { RadioGroup } from '../components/forms/radio-group/RadioGroup.jsx';
...
const WITH_A_BLANK_NAME = new Map([
  ...
  ['Table', () => <Table label={BLANK} columns={[{ key: 'a', label: 'A' }]} />],
  ['Pagination', () => <Pagination ariaLabel={BLANK} page={1} pageCount={3} />],
]);

export function guardedNames(dir, read = readFileSync, list = readdirSync) {
  const found = [];
