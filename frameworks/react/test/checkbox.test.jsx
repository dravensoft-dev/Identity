 ...
 * is therefore NOT verified by this suite, AND IT IS NOT VERIFIED ANYWHERE ELSE
 * EITHER. It was, by frameworks/react/test-dom/form-control-events.test.jsx, which
 * clicked the real checkbox and asserted the payload was a boolean before asserting
 * what it equalled; that directory was deleted for its RAM cost and React's DOM
 * behaviour is now checked by eye against the demo page. See CLAUDE.md's Known debt.
 * What IS verified here is the half SSR can see:
