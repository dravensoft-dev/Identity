...
import type { CatSlot, SeriesTone } from './Api.generated';

export declare const CAT_SLOTS: number;
export declare const CHART_HEIGHT: number;
export declare const PAD: { t: number; r: number; b: number; l: number };

export declare function catColor(slot: number): string;
export declare function toneColor(tone: SeriesTone): string | undefined;
...
export declare function resolveColors(options: ResolveColorsOptions): string[];
