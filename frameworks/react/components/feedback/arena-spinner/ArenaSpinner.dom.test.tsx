...
const BINDING = join(REACT_COMPONENTS, 'feedback/arena-spinner/ArenaSpinner.behaviour.json');

test('ArenaSpinner meets the progressbar pattern, reporting work with no value', () => {
  const root = mount(<ArenaSpinner label="Loading projects" />);
