...
function Demo(){
  return (
    <div style={{display:'flex',flexDirection:'column',gap:'calc(var(--sp-1) * 3.5)',maxWidth:'calc(var(--sp-1) * 130)'}}>
      ...
      <Alert tone="warning" title="Staging environment" actionLabel="Go to production" onAction={()=>{}}>Changes here don't affect real users.</Alert>
      <Alert tone="danger" title="Certificate expired" dismissible onClose={()=>{}}>Renew the TLS within 48 h to avoid outages.</Alert>
    </div>
  );
}
