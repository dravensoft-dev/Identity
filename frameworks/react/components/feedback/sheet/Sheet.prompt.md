...
<!-- @api GENERATED from contracts/api/components/Sheet.json. Edit the contract, not this table. -->
...
| `dismissible` | primitive | `boolean` | `false` | Whether the close control is shown. Every layer gates it on this member and never on whether anything listens for `close`, per R6. |
