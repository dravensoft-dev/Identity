...
function reflects(render, selector, attribute) {
...
test('Input reflects readonly and required, and is a single-line textbox', () => {
  reflects((v) => <Input label="Project" readOnly={v} />, 'input', 'readonly');
  reflects((v) => <Input label="Project" required={v} />, 'input', 'required');
  ...
  assert.ok(root.querySelector('label[for="' + el.getAttribute('id') + '"]'),
...
test('Textarea reflects readonly and required, and is a multi-line textbox', () => {
  reflects((v) => <Textarea label="Notes" readOnly={v} />, 'textarea', 'readonly');
  reflects((v) => <Textarea label="Notes" required={v} />, 'textarea', 'required');
