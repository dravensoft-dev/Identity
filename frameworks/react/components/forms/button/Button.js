...
function useSpinKeyframes() {
  useEffect(() => {
    ...
    s.textContent = "@keyframes arena-btn-spin{to{transform:rotate(360deg)}}" + ".arena-btn-spin{animation:arena-btn-spin var(--loop-spin) linear infinite}" + "@media (prefers-reduced-motion:reduce){.arena-btn-spin{animation-duration:var(--loop-reduced)}}";
