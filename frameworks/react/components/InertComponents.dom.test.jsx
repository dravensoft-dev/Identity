...
import { Avatar } from './display/avatar/Avatar.jsx';
import { Badge } from './display/badge/Badge.jsx';
import { Card } from './display/card/Card.jsx';
import { StatCard } from './display/stat-card/StatCard.jsx';
import { UnauthCard } from './display/unauth-card/UnauthCard.jsx';
import { ChartCard } from './charts/chart-card/ChartCard.jsx';
import { EmptyState } from './feedback/empty-state/EmptyState.jsx';
import { PageHead } from './navigation/page-head/PageHead.jsx';
import { SideNavSection } from './navigation/side-nav-section/SideNavSection.jsx';
...
export function inertProblems(root) {
  const problems = [];
