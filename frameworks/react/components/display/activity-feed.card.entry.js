...
function Demo() {
  ...
  }, "renderItem — the row the grammar does not fit"), React.createElement(Card, null, React.createElement(ActivityFeed, {
    items: [{ id: 9, label: "Retention policy changed by two people at once" }],
    renderItem: (e) => React.createElement("span", {
