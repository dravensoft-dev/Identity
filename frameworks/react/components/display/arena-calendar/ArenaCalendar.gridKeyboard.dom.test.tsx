...
const BINDING = join(REACT_COMPONENTS, 'display/arena-calendar/ArenaCalendar.behaviour.json');
...
function grid() {
  root ??= mount(
    <ArenaCalendar timeZone="UTC" anchorDate="2026-07-20" view="week" dayStart="09:00" dayEnd="14:00">
      <ArenaCalendarEvent id="a" title="Standup" start="2026-07-20T09:00:00Z" end="2026-07-20T09:30:00Z" colorId={1} />
      <ArenaCalendarEvent id="b" title="Review" start="2026-07-21T14:00:00Z" end="2026-07-21T15:00:00Z" colorId={2} />
    </ArenaCalendar>,
  );
...
test('ArenaCalendar agrees with its own behaviour binding, in both directions', () => {
  const g = grid();
  assertPattern({
    root: root!,
    bindingPath: BINDING,
