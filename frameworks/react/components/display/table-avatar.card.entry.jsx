...
function Demo(){
  ...
  return (
    <div>
      <div className="sub" style={{marginBottom:12}}>Avatar — person · entity · presence</div>
      ...
      <div className="sub" style={{marginBottom:12}}>Table — with Badge in a cell</div>
      <Table columns={columns} rows={rows} getRowKey={r=>r.build} onRowClick={()=>{}} />
      <div className="sub" style={{marginTop:20,marginBottom:12}}>Card mode — the SAME table in a 340px container</div>
