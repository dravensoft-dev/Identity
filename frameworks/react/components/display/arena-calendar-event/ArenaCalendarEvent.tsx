...
export interface ArenaCalendarEventProps {
  ...
  /** The action panel's content, revealed by the chip's action button. Rendered only while the panel is open, so a consumer's own controls never sit permanently in the grid's ArenaTab sequence. */
...
HTMLElement, ArenaCalendarEventProps & Partial<CalendarEventInjected>
