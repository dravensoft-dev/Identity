...
export interface BottomNavProps {
  ...
  /** The id of the current destination. The BottomNavItem whose id matches is marked aria-current="page" and draws its glyph in the filled weight, and no item is marked when it names none of them. */
  active?: string;
  ...
  /** The destinations. One BottomNavItem each; which id is active and how each reports `nav` are the parent's to settle, and none of it is a member here. */
