...
**Do / Don't**
- Do write one `<Tab>` per view, with that view as its children. There is no `tabs` array and no
...
with `bun run demos`, open `frameworks/react/components/navigation/tabs/Tabs.demo.generated.html`,
