...
export function BottomNavItem({
  ...
  activeId, onActivate,
}: BottomNavItemProps & Partial<BottomNavInjected>) {

  if (!id) throw new Error('BottomNavItem: `id` is required');
  if (!label) throw new Error('BottomNavItem: `label` is required');
