...
import { ArenaCommandPalette, arenaCapCommands, arenaOrderCommands, arenaCommandGroups } from './ArenaCommandPalette.tsx';
...
test('maxResults caps the matches, and the cap runs after the search rather than before it', () => {
  assert.deepEqual([...arenaCapCommands(COMMANDS, 2)].map((c) => c.id), ['sale', 'help'],
