...
export declare function trapTabKey(
  container: Element,
  event: Pick<KeyboardEvent, 'shiftKey'> & { preventDefault(): void },
...
export declare function useDialogModal(options: DialogModalOptions):
