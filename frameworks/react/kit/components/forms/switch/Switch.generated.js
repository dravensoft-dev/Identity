...
function useKnobTransition() {
  useEffect(() => {
    ...
    s.textContent = ".arena-switch-knob{transition:transform var(--dur-mid) var(--ease-out)}" + "@media (prefers-reduced-motion:reduce){.arena-switch-knob{transition:none}}";
...
export function Switch({
  ...
  return React.createElement("span", {
    ...
    "aria-hidden": "true",
    className: icon,
    style: { fontSize: dims.icon, lineHeight: "var(--lh-tight)", color: "var(--crimson)" }
