...
import { resolveColors, arcPath, srOnly, CHART_HEIGHT } from "../../../DataVisuals.generated.js";
...
export function DoughnutChart({ labels, values, seriesLabel, slots, valueSuffix }) {
  if (!seriesLabel)
    throw new Error("DoughnutChart: `seriesLabel` is required (it names the series for the accessible name, and nothing can derive that)");
  if (!labels)
  ...
  return React.createElement("div", {
    ...
    tabIndex: 0,
    role: "group",
    "aria-label": "Doughnut chart legend",
  ...
  }, fmt(values[i] ?? 0))))), React.createElement("table", {
    style: srOnly
